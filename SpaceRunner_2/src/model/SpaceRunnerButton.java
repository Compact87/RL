...
public class SpaceRunnerButton extends Button {
    ...
    private final String BUTTON_PRESSED_STYLE="-fx-background-color: transparent; -fx-background-image: url('yellow_button_pressed2.png');";
    ...
    private void setButtonFont(){
        ...
        }catch (Exception e){setFont(Font.font("Verdana",23));}
    ...
    private void initiallizeButtonListeners(){
